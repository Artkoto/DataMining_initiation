...
//    }};
    ...
    public static void main(String[] args) {
        ...
        System.out.println("warior : "+ nbWarrio);
        System.out.println("prest : "+ nbPriest);
        System.out.println("drui : "+ nbDruid);
        System.out.println("paladin : "+ nbPaladin);
        System.out.println("hunter : "+ nbHunter);
        System.out.println("warlock : "+ nbWarlock);
        System.out.println("shaman : "+ nbShaman);
        System.out.println("rogue : "+ nbRogue);
        System.out.println("Mage : "+ nbMage +"\n");

        System.out.println("cartes Communune\n");
        for (String s : cartesCommunes){
            System.out.println(s);
        }
        System.out.println("");
